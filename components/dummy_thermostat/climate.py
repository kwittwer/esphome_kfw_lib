...
CONFIG_SCHEMA = climate.climate_schema(DummyThermostat).extend(
    {
        ...
        cv.Optional(CONF_SENSOR_TIMEOUT, default="600s"): cv.positive_time_period_seconds,
        cv.Optional(CONF_FALLBACK_SENSOR_TIMEOUT, default="600s"): cv.positive_time_period_seconds,
        cv.Optional(CONF_FALLBACK_HUMIDITY_SENSOR): cv.use_id(sensor.Sensor),
        cv.Optional(CONF_HUMIDITY_SENSOR_TIMEOUT, default="0s"): cv.positive_time_period_seconds,
        cv.Optional(CONF_VALVE_UPDATE_TIMEOUT, default="0s"): cv.positive_time_period_seconds,
